...
Geometry.prototype.vertexCount = function () {
  ...
  function ShaderProgram (gl, vertSrc, fragSrc) {
    ...
    this.normal = this.gl.getAttribLocation(program, 'normal')
    this.uv = this.gl.getAttribLocation(program, 'uv')
    this.model = this.gl.getUniformLocation(program, 'model')
    this.view = this.gl.getUniformLocation(program, 'view')
    this.projection = this.gl.getUniformLocation(program, 'projection')
    this.vert = vert
    this.frag = frag
